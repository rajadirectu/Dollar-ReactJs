                ...
                <Grid container spacing={4}>
                    <Grid container item xs={12} md={6} direction="column" spacing={2}>
                        ...
                        <Controller name="firstName" control={control} defaultValue=""
                            rules={{ required: true }}
                            render={({ field }) => (
                                <TextField {...field} lg={4} label="First Name" variant="outlined" autoComplete="off" margin="dense" className={classes.textField} size="small" error={!!errors.firstName}
                        ...
                        <Controller name="lastName" control={control} defaultValue=""
                            rules={{ required: true }}
                            render={({ field }) => (
                                <TextField {...field} label="Last Name" variant="outlined" margin="dense"  autoComplete="off" size="small" className={classes.textField} error={!!errors.lastName}
                        ...
                        <Controller name="email" control={control} defaultValue=""
                            ...
                            render={({ field }) => (
                                <TextField {...field} type="email" label="Email" variant="outlined" margin="dense" autoComplete="off" size="small" className={classes.textField} error={!!errors.email}
                        ...
                        {/* <Controller name="jurisdictionType" control={control}
                            ...
                            render={({ field }) => (
                                <Autocomplete {...field}
                                    ...
                                    style={{ width: 300 }}
                                    renderInput={(params) => <TextField {...params} label="Jurisdiction Type" margin="dense" autoComplete="off" variant="outlined" size="small" className={classes.textField} />}
                                />
                            )}
                        /> */}
                        ...
                        <Controller name="siteSurvey" control={control} defaultValue=""
                            ...
                            render={({ field }) => (
                                <TextField {...field} type="text" label="Site Survey" variant="outlined" margin="dense" size="small" autoComplete="off" className={classes.textField} error={!!errors.siteSurvey}
                        ...
                        />
                         <Controller name="permitFee" control={control} defaultValue=""
                            ...
                            render={({ field }) => (
                                <TextField {...field} type="text" label="Permit Fee" variant="outlined" margin="dense" size="small" autoComplete="off" className={classes.textField} error={!!errors.permitFee}
                    ...
                    <Grid container item xs={12} md={6} direction="column" spacing={2}>
                        <Controller name="password" control={control} defaultValue=""
                            ...
                            render={({ field }) => (
                                <TextField {...field} type="password" label="Password" variant="outlined" margin="dense" size="small" autoComplete="off" className={classes.textField} error={!!errors.password}
                        ...
                        <Controller name="address" control={control} defaultValue=""
                            ...
                            render={({ field }) => (
                                <TextField {...field} type="address" label="Address" variant="outlined" margin="dense" size="small" autoComplete="off" multiline className={classes.textField} error={!!errors.address}
                        ...
                        <Controller name="jurisdictionName" control={control} defaultValue=""
                            ...
                            render={({ field }) => (
                                <TextField {...field} type="text" label="JurisdictionName" variant="outlined" margin="dense" size="small" autoComplete="off" className={classes.textField} error={!!errors.jurisdictionName}
                        ...
                        />
                         <Controller name="permitFee" control={control} defaultValue=""
                            ...
                            // }}
                            render={({ field }) => (
                                <TextField {...field} type="text" label="Permit Fee" variant="outlined" margin="dense" size="small" autoComplete="off" className={classes.textField} 
                                    helperText={errors.permitFee && errors.permitFee?.message &&
                                        <span className="invalid-feedback">{errors.permitFee.message}</span>
                                    }
                                />
                        ...
                        />
                         <Controller name="amount" control={control} defaultValue=""
                            // rules={{
                            //     required: true,
                            // }}
                            render={({ field }) => (
                                <TextField {...field} type="text" label="Amount" variant="outlined" margin="dense" size="small" autoComplete="off" className={classes.amount} 
                                    helperText={errors.amount && errors.amount?.message &&
                                        <span className="invalid-feedback">{errors.amount.message}</span>
                                    }
                                />
                            )}
                        />
